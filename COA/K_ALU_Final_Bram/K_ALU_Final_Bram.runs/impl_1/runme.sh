...
HD_PWD='C:/Users/adity/K_ALU_Final_Bram/K_ALU_Final_Bram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_top_wrapper.tcl -notrace
