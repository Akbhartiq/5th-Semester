...
HD_PWD='C:/Users/adity/K_ALU_Final_Bram/K_ALU_Final_Bram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_top_wrapper.tcl
